...
SECRET_KEY = 'django-insecure-xe@1%$-w%97+6%h1fj!tg8-o$507nso%-)b0gwcs(ef_7s+n7g'
...
# Encryption Key (should match the Flask one or be read from environment in production)
import os
